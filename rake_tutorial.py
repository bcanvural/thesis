...
rake_object = rake.Rake(stoppath, 5, 1, 10)

# 2. run on RAKE on a given text
# sample_file = io.open("Categories/Machine_Learning/Clustering.txt", 'r',encoding="iso-8859-1")
# sample_file = io.open("Categories/Machine_Learning/Unsupervised learning.txt", 'r',encoding="iso-8859-1")
sample_file = io.open("jobs-collected", 'r',encoding="iso-8859-1")

text = sample_file.read()

#
# keywords = [x[0] for x in rake_object.run(text)]
#
# # 3. print results
