...
def main():
    ...
    countVectorizer = CountVectorizer(inputCol="filtered", outputCol="rawFeatures", vocabSize=VOCAB_SIZE, minDF=4.0)
    ...
    ordered.rdd.saveAsTextFile('cosine-calculated-countvectorizer')
    ...
    ordered_cat_cv.rdd.saveAsTextFile('category-cosine-calculated-countvectorizer')
