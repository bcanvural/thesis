...
alias cc2="rm -rf Calculated/tfidf"
alias rr3="spark-submit countvectorizer.py"
alias cc3="rm -rf Calculated/countvectorizer/"
alias rr4="spark-submit word2vec.py"
alias cc4="rm -rf Calculated/word2vec"
alias rr5="spark-submit word2vec2.py"
alias cc5="rm -rf Calculated/word2vec2"
